  ...
  directiveModule.directive('ngDropdownMultiselect', ['$filter', '$document', '$compile', '$parse', function ($filter, $document, $compile, $parse) {
    return {
      ...
      template: function (element, attrs) {
        ...
        template += '<a ng-keydown="option.disabled || keyDownLink($event)" role="menuitem" class="option" tabindex="-1" ng-click="option.disabled || setSelectedItem(getPropertyForObject(option,settings.idProp), false, true)" ng-disabled="option.disabled" title="{{getPropertyForObject(option,settings.displayProp)}}">';
      ...
      link: function ($scope, $element, $attrs) {
        ...
        $scope.internalControl.resetQuerySearchBox = function () {
          $scope.input.searchFilter = '';
        }
      }
    };
